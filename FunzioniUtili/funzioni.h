...
template <typename T>
vector<T> read_all(const char *filename)
{
  ifstream f(filename);
  vector<T> data;
  if (!f)
...
template <typename T>
double media(typename vector<T>::const_iterator begin, typename vector<T>::const_iterator end)
{
...
template <typename T>
double varianza(typename vector<T>::const_iterator begin, typename vector<T>::const_iterator end)
{
...
template <typename T>
double mediana(const vector<T> v)
{
  vector<T> temp = v;
...
template <typename T>
void print(typename vector<T>::const_iterator begin, typename vector<T>::const_iterator end)
{
...
template <typename T>
void print(typename vector<T>::const_iterator begin, typename vector<T>::const_iterator end, const char *filename)
{
  ofstream f(filename);
...
// vector<TGraph *> *tgraphs_with_data(const vector<TGraphData> &data)
// {
...
//     for (int i = 0; i < min(data[k].x.size(), data[k].y.size()); i++)
//     {
//       graph->AddPoint(data[k].x[i], data[k].y[i]);
//     }
//   }
//   return &graphs;
// }
